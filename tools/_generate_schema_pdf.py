...
CREATE TABLE employees (
    ...
    title VARCHAR(255), birth_date DATE, hire_date DATE,
...
CREATE TABLE orders (
    ...
    order_date DATE, required_date DATE,
    shipped_date DATE, freight DOUBLE PRECISION,
...
CREATE TABLE employees (
    ...
    birth_date DATE, hire_date DATE, phone TEXT, notes TEXT,
    street TEXT, city TEXT, region TEXT, postal_code TEXT, country TEXT,
    reports_to TEXT,
...
CREATE TABLE orders (
    customer_id TEXT, order_date DATE, order_id TEXT,
    required_date DATE, shipped_date DATE, freight DOUBLE,
